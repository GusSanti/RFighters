...
function module.UseSkill(char: Model)
	...
	task.delay(0.6,function()
		...
		hitbox.OnTouch = function(enemyCharacter)
			...
			if ArenaBounds then
				char:PivotTo(CFrame.new(ArenaBounds:GetPivot().X, ArenaBounds:GetPivot().Y - 38, ArenaBounds:GetPivot().Z) * CFrame.Angles(0, math.rad(90), 0))
			end
			...
			Assets.Events.Replicate:FireAllClients("GrimmUltimate", {Char = char, Enemy = enemyCharacter})
